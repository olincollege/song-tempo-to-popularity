...
def scatterplot():
    ...
    fifties_data = [df2['1950'], df2['1951'], df2['1952'], df2['1953'], df2['1954'], df2['1955'], df2['1956'], df2['1957'], df2['1958'], df2['1959']]
    sixties_data = [df2['1960'], df2['1961'], df2['1962'], df2['1963'], df2['1964'], df2['1965'], df2['1966'], df2['1967'], df2['1968'], df2['1969']]
    seventies_data = [df2['1970'], df2['1971'], df2['1972'], df2['1973'], df2['1974'], df2['1975'], df2['1976'], df2['1977'], df2['1978'], df2['1979']]
    eighties_data = [df2['1980'], df2['1981'], df2['1982'], df2['1983'], df2['1984'], df2['1985'], df2['1986'], df2['1987'], df2['1988'], df2['1989']]
    nineties_data = [df2['1990'], df2['1991'], df2['1992'], df2['1993'], df2['1994'], df2['1995'], df2['1996'], df2['1997'], df2['1998'], df2['1999']]
    twothousand_data = [df2['2000'],df2['2001'],df2['2002'],df2['2003'],df2['2004'],df2['2005'], df2['2006'],df2['2007'],df2['2008'],df2['2009']]
    twentytens_data = [df2['2010'],df2['2011'],df2['2012'],df2['2013'],df2['2014'],df2['2015'],df2['2016'],df2['2017'],df2['2018'],df2['2019']]
    plt.scatter(x,forties_data, c = 'red', label = '1940s')
    plt.scatter(x,fifties_data, c = 'orange', label = '1950s')
    plt.scatter(x,sixties_data, c = 'yellow', label = '1960s')
    plt.scatter(x,seventies_data, c = 'green', label = '1970s')
    plt.scatter(x,eighties_data, c = 'blue', label = '1980s')
    plt.scatter(x,nineties_data, c = 'purple', label = '1990s')
    plt.scatter(x,twothousand_data, c = 'pink', label = '2000s')
    plt.scatter(x,twentytens_data, c = 'grey', label = '2010s')
