...
df = pd.DataFrame(index = range(1,101), columns = range(1940,2022))
# print(len(df))

for i in range(1,101):
    df.at[i,2018] = split_list[i-1]
    
df.to_csv("../data/top100.csv")
print(df)

# print(type(pd.DataFrame.index))
# for row in pd.DataFrame.index:
#     df.at(row,2018) = split_list()
